...
export const BUILTIN_PROVIDER_CATALOG: readonly ProviderCatalogEntry[] = [
  ...
  },
  {
    ...
    order: 211,
    aliases: ['serpbase-search', 'serpbase-news'],
    display: {
      family: 'SerpBase',
      name: 'SerpBase',
      description: 'Google web and news results through SerpBase.',
      best_for: 'Ranked Google sources with optional bounded SERP context.',
      setup_url: 'https://serpbase.dev/docs',
    },
    credential: {
