...
export const BUILTIN_PROVIDER_CATALOG: readonly ProviderCatalogEntry[] = [
  ...
  },
  {
    ...
    profiles: [
      declare({
        profile_id: 'grounded',
        selection_order: 200,
        target: fixedTarget('model', 'sonar-pro'),
  ...
  },
  {
    ...
    display: {
      ...
      best_for: 'Higher-effort official Perplexity searches with native cost.',
      setup_url: PERPLEXITY_SETUP_URL,
    },
    credential: {
      env_var: 'PERPLEXITY_API_KEY',
  ...
  },
  {
    ...
    profiles: [
      declare({
        profile_id: 'research',
        selection_order: 100,
        target: fixedTarget('model', 'sonar-deep-research'),
        result_kind: 'research_report',
        grounding_policy: 'required',
        corpora: ['web'],
        retrieval_method: 'research_agent',
  ...
  },
  {
    ...
    profiles: [
      declare({
        ...
        operator_id: 'perplexity',
        invocation: 'background',
        // The Agent API is polled in-process; no durable resume handle exists,
        // so async selection must reject this profile.
  ...
  },
  {
    ...
    display: {
      ...
      best_for: 'More exhaustive Perplexity runs.',
      setup_url: PERPLEXITY_SETUP_URL,
    },
    credential: {
      env_var: 'PERPLEXITY_API_KEY',
  ...
  },
  {
    ...
    profiles: [
      ...
      declare({
        profile_id: 'chat',
        selection_order: 540,
        // The audit intentionally left Parallel defaults unset; #2582 binds it.
        target: providerManagedTarget(),
        result_kind: 'grounded_answer',
        grounding_policy: 'optional',
        corpora: ['web'],
