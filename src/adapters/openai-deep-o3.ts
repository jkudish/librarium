...
/**
 * OpenAI Deep Research provider (o3 model).
 * Uses o3-deep-research for higher-quality deep research.
 * Tier: deep-research (async)
 */
export class OpenAIDeepO3Provider extends BaseProvider {
  ...
  async retrieve(handle: AsyncTaskHandle): Promise<ProviderResult> {
    ...
    try {
      ...
      return {
        ...
        citations,
        durationMs,
        model: data.model ?? 'o3-deep-research',
        tokenUsage: {
