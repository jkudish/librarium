...
export interface SearchApiGeminiProviderOptions extends BaseProviderOptions {
  zeroRetention?: boolean;
  retry?: HttpRetryPolicy;
}

/** SearchAPI-observed Gemini answer. */
export class SearchApiGeminiProvider extends BaseProvider {
  readonly id = 'searchapi-gemini';
  readonly tier: ProviderTier = 'ai-grounded';
  private readonly zeroRetention: boolean;
  private readonly retry?: HttpRetryPolicy;

  constructor(options: SearchApiGeminiProviderOptions = {}) {
    super(options);
