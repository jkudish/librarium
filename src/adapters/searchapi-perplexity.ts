...
export interface SearchApiPerplexityProviderOptions
  extends BaseProviderOptions {
  zeroRetention?: boolean;
  retry?: HttpRetryPolicy;
}

/** SearchAPI-observed Perplexity answer. */
export class SearchApiPerplexityProvider extends BaseProvider {
  readonly id = 'searchapi-perplexity';
  readonly tier: ProviderTier = 'ai-grounded';
  private readonly zeroRetention: boolean;
  private readonly retry?: HttpRetryPolicy;

  constructor(options: SearchApiPerplexityProviderOptions = {}) {
    super(options);
