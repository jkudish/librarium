...
/**
 * Shared base for OpenAI Deep Research providers.
 * Subclasses only need to declare id and model.
 */
export abstract class OpenAIDeepBaseProvider extends BaseProvider {
