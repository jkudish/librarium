...
function matrixIdentity(value: unknown): ReleaseMatrixIdentity {
  ...
  return parseMatrixCore(
    ...
    matrix.fingerprint,
    {
      ...
      count: 'Release candidate requires the exact sorted 41-profile matrix.',
      ordering:
        'Release candidate requires the exact sorted 41-profile matrix.',
      ...
      fingerprintMismatch:
        'Canonical matrix fingerprint does not match its exact 41 targets.',
    },
  );
}
...
function parseMatrixIdentity(value: unknown): ReleaseMatrixIdentity {
  ...
  return parseMatrixCore(
    ...
    identity.matrix_fingerprint,
    {
      ...
      targetsArray:
        'Frozen installed-package identity must contain exactly 41 targets.',
      count:
        'Frozen installed-package identity must contain exactly 41 targets.',
      ...
      fingerprintMismatch:
        'Frozen matrix fingerprint does not match its exact 41 targets.',
    },
  );
}
